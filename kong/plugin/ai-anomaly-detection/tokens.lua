...
local function check_for_anomalies(conf, request_data)
    ...
    local gpt_payload = {
        ...
        messages = {
            {role = "system", content = "You are an AI that detects anomalies in API requests. If any anomalies are found append keyword anomaly found in response along with the type of anamoly. Provide a severity_score as well."},
